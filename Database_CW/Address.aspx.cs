...
namespace Database_CW
{
    public partial class Address : Page
    {
        ...
        {
            string connection = "Data Source=XE;User ID=amrit_adk_cw1;Password=amrit;";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            OracleCommand cmd = new OracleCommand("Insert into Address values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "')", con);
            cmd.ExecuteNonQuery();
